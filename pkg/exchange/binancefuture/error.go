...
// APIError represents a Binance Futures API error response
...
func (e *APIError) Error() string {
	return fmt.Sprintf("binance futures api error: code=%d, msg=%s", e.Code, e.Message)
}

// Common Binance Futures API error codes
const (
	// General errors
	ErrCodeUnknown                 = -1000
	...
	ErrCodeInvalidLeverage        = -4046
	ErrCodeLeverageNotModified    = -4047
	ErrCodePositionNotModified    = -4048
	ErrCodeInvalidMarginType      = -4049
	ErrCodeInvalidPositionSide    = -4050
	ErrCodeInvalidReduceOnly      = -4051
	ErrCodeInvalidClosePosition   = -4052
	ErrCodeInvalidWorkingType     = -4053
	ErrCodeInvalidPriceProtect    = -4054
	ErrCodeInvalidActivationPrice = -4055
	ErrCodeInvalidCallbackRate    = -4056
	ErrCodeInvalidQuantity        = -4057
	ErrCodeInvalidPrice           = -4058
	ErrCodeInvalidStopPrice       = -4059
	ErrCodeInvalidTimeInForce     = -4060
	ErrCodeInvalidOrderType       = -4061
	ErrCodeInvalidSide            = -4062
)
...
var ErrorCodeMessages = map[int]string{
	...
	ErrCodeInvalidLeverage:         "Invalid leverage",
	ErrCodeLeverageNotModified:     "Leverage not modified",
	ErrCodePositionNotModified:     "Position not modified",
	ErrCodeInvalidMarginType:       "Invalid margin type",
	ErrCodeInvalidPositionSide:     "Invalid position side",
	ErrCodeInvalidReduceOnly:       "Invalid reduce only",
	ErrCodeInvalidClosePosition:    "Invalid close position",
	ErrCodeInvalidWorkingType:      "Invalid working type",
	ErrCodeInvalidPriceProtect:     "Invalid price protect",
	ErrCodeInvalidActivationPrice:  "Invalid activation price",
	ErrCodeInvalidCallbackRate:     "Invalid callback rate",
	ErrCodeInvalidQuantity:         "Invalid quantity",
	ErrCodeInvalidPrice:            "Invalid price",
	ErrCodeInvalidStopPrice:        "Invalid stop price",
	ErrCodeInvalidTimeInForce:      "Invalid time in force",
	ErrCodeInvalidOrderType:        "Invalid order type",
	ErrCodeInvalidSide:             "Invalid side",
}
